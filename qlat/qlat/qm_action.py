...
class QMAction:
    ...
    def __init__(self, alpha, beta, FV_offset, barrier_strength, M, L, t_full1, t_full2, t_FV_out, t_FV_mid, t_TV_start, dt):
        self.cdata = c.mk_qm_action(alpha, beta, FV_offset, barrier_strength, M, L, t_full1, t_full2, t_FV_out, t_FV_mid, t_TV_start, dt)

...
class QMAction:
    ...
    def __init__(self, alpha, beta, start_TV, barrier_strength, M, L, t_full1, t_full2, t_FV, dt):
        self.cdata = c.mk_qm_action(alpha, beta, start_TV, barrier_strength, M, L, t_full1, t_full2, t_FV, dt)

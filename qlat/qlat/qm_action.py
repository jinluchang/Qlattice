...
class QMAction:
    ...
    def __init__(self, lmbd, v0, alpha, barrier_strength, M, L, t_full, t_FV, m_particle, dt):
        self.cdata = c.mk_qm_action(lmbd, v0, alpha, barrier_strength, M, L, t_full, t_FV, m_particle, dt)

...
cdef extern from "qlat/hlbl-contract.h" namespace "qlat":
    ...
    #
    std_vector[SlTable] contract_two_plus_two_pair_no_glb_sum(Long& n_points_in_r_sq_limit, Long& n_points_computed, const ComplexD& coef, const PointsSelection& psel, const SelectedPoints[RealD]& psel_prob, const FieldSelection& fsel, const SelectedField[RealD]& fsel_ps_prob, const Long idx_xg_x, const SelectedField[ComplexD]& s_hvp_x, const SelectedPoints[ComplexD]& edl_list_c, const Long r_sq_limit, const RealD muon_mass, const RealD z_v) except +
    #

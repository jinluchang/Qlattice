...
dict_params["24D"][tag] = list(range(8, 64, 8))
dict_params["32D"][tag] = list(range(8, 64, 8))
dict_params["32Dfine"][tag] = list(range(8, 64, 8))
dict_params["24DH"][tag] = list(range(8, 64, 8))
dict_params["48I"][tag] = list(range(8, 96, 8))
dict_params["64I"][tag] = list(range(8, 128, 8))

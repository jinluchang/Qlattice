...
//int get_threads_GPU(unsigned int thread, unsigned int Total)
//{
//  for(unsigned int temb=thread;temb<Total;temb++){if(Total%temb == 0){return temb;}}
//  return 1;
//}
...
void matrix_prod_gpu(Ty* a, Ty* b, Ty* c, const long m, const long n, const long w, const long L=1, bool Conj=true, bool dummy = true, bool trans=false, int modeGPU = 2)
{
  ...
  //////matrix_prod_global0<<< dimGrid, dimBlock >>>(a, b, c, w);
  //switch (nt)
  //{
  //  case 1024:mprodG<1024, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 512: mprodG< 512, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 256: mprodG< 256, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 128: mprodG< 128, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 64:  mprodG<  64, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 32:  mprodG<  32, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 16:  mprodG<  16, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 8:   mprodG<   8, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 4:   mprodG<   4, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 2:   mprodG<   2, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //  case 1:   mprodG<   1, Ty ><<< dimGrid, dimBlock >>>(a, b, c, m, n, w); break;
  //}

...
usage_message = """
Usage:
    python -m qlat_cps_config [--cxxflags] [--ldflags] [--libs] [--LD_LIBRARY_PATH] [--eigen-type]
""".strip()
...
from qlat_cps_config import get_include_list, get_lib_list, get_new_ld_library_path, get_eigen_type

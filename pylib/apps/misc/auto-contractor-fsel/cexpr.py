...
def get_cexpr_3f4f_matching():
    ...
    def calc_cexpr():
        ...
        exprs_src = [
            ...
            mk_Q0_b81("t2_1", "even") + "Q0_b81wsrc(e)",
            mk_Q1_b81("t2_1", "even") + "Q1_b81wsrc(e)",
            mk_Q2_b81("t2_1", "even") + "Q2_b81wsrc(e)",
            mk_Q3_b81("t2_1", "even") + "Q3_b81wsrc(e)",
            mk_Q4_b81("t2_1", "even") + "Q4_b81wsrc(e)",
            mk_Q0_b81("t2_1", "odd") + "Q0_b81wsrc(o)",
            mk_Q1_b81("t2_1", "odd") + "Q1_b81wsrc(o)",
            mk_Q2_b81("t2_1", "odd") + "Q2_b81wsrc(o)",
            mk_Q3_b81("t2_1", "odd") + "Q3_b81wsrc(o)",
            mk_Q4_b81("t2_1", "odd") + "Q4_b81wsrc(o)",
        ]
        exprs_snk = [
            mk_pipi_i20("t1_1", "t1_2", True) + "pipi_I2_t1_2",
            mk_pipi_i0("t1_1", "t1_2", True) + "pipi_I0_t1_2",
            mk_kk_i20("t1_1", "t1_2", True) + "KK_I2_t1_2",
            mk_kk_i0("t1_1", "t1_2", True) + "KK_I0_t1_2",
            mk_pipi_i20("t1_1", "t1_3", True) + "pipi_I2_t1_3",
            mk_pipi_i0("t1_1", "t1_3", True) + "pipi_I0_t1_3",
            mk_kk_i20("t1_1", "t1_3", True) + "KK_I2_t1_3",
            mk_kk_i0("t1_1", "t1_3", True) + "KK_I0_t1_3",
            mk_pipi_i20("t1_1", "t1_4", True) + "pipi_I2_t1_4",
            mk_pipi_i0("t1_1", "t1_4", True) + "pipi_I0_t1_4",
            mk_kk_i20("t1_1", "t1_4", True) + "KK_I2_t1_4",

...
rup.dict_params["16IH2"]["trajs"] = list(range(500, 10000, 10))
rup.dict_params["32IfineH"]["trajs"] = list(range(500, 10000, 50))
rup.dict_params["24IH1"]["trajs"] = list(range(500, 10000, 100))
rup.dict_params["24IH2"]["trajs"] = list(range(500, 10000, 100))
rup.dict_params["32IH2"]["trajs"] = list(range(500, 10000, 10))

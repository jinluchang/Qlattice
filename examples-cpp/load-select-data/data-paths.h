...
inline std::string get_points_selection_path(const std::string& job_tag,
                                             const int traj)
{
  return ssprintf("data/points-selection/%s/traj=%d.txt", job_tag.c_str(),
                  traj);
}
...
inline std::string get_point_src_info_simulated_path(const std::string& job_tag,
                                                     const int traj)
{
  return ssprintf("data/point-src-info-simulated/%s/traj=%d.txt",
                  job_tag.c_str(), traj);
}

inline std::string get_point_distribution_path(const std::string& job_tag)
{
  return ssprintf("data/point-distribution/%s/point-distribution.txt",
                  job_tag.c_str());
}
...
inline std::string get_field_selection_path(const std::string& job_tag,
                                            const int traj)
{
  return ssprintf("data/field-selection/%s/traj=%d.field", job_tag.c_str(),
                  traj);
}
...
inline std::string get_gauge_transform_path(const std::string& job_tag,
                                            const int traj)
{
  return ssprintf("data/gauge-transform/%s/traj=%d.field", job_tag.c_str(),
                  traj);
}
...
inline std::string get_psel_prop_psrc_light_path(const std::string& job_tag,
                                                 const int traj)
{
  return ssprintf("data/psel-prop-psrc-light/%s/traj=%d", job_tag.c_str(),
                  traj);
}
...
inline std::string get_psel_prop_psrc_strange_path(const std::string& job_tag,
                                                   const int traj)
{
  return ssprintf("data/psel-prop-psrc-strange/%s/traj=%d", job_tag.c_str(),
                  traj);
}
...
inline std::string get_psel_prop_psrc_exact_path(const std::string& job_tag,
                                                 const int traj)
{
  return ssprintf("data/psel-prop-psrc-exact/%s/traj=%d", job_tag.c_str(),
                  traj);
}
...
inline std::string get_psel_prop_wsrc_light_path(const std::string& job_tag,
                                                 const int traj)
{
  return ssprintf("data/psel-prop-wsrc-light/%s/traj=%d", job_tag.c_str(),
                  traj);
}
...
inline std::string get_psel_prop_wsrc_strange_path(const std::string& job_tag,
                                                   const int traj)
{
  return ssprintf("data/psel-prop-wsrc-strange/%s/traj=%d", job_tag.c_str(),
                  traj);
}

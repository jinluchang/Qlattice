...
q.json_results_append(qac.display_cexpr(cexpr))
...
q.json_results_append(qac.display_cexpr(cexpr_opt))
...
for is_cython in [
    ...
    q.json_results_append(qac.cexpr_code_gen_py(cexpr_opt, is_cython=is_cython))
    ...
    for name in qac.get_expr_names(ccexpr):
        q.json_results_append(name)
    base_positions_dict = dict()
    base_positions_dict["mom"] = q.CoordinateD(
        [
            0,
            0,
            1,

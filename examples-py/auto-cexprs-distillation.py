...
from auto_contractor.operators import (
    mk_expr, mk_k_p, mk_k_0, mk_pi_p, mk_j5pi_mu, mk_j5k_mu, mk_a0_p,
    mk_kappa_p, mk_pi_0, mk_k_0_bar, mk_j5km_mu, mk_k_m, mk_pi_m, mk_m,
    contract_simplify_compile, sympy,
)
...
@q.timer
def get_cexpr_zeros():
    fn_base = "cache/auto_contract_cexpr/get_cexpr_zeros"
    #
    def calc_cexpr():
        exprs = [
            mk_expr(0),
...
def get_cexpr_meson_corr2():
    fn_base = "cache/auto_contract_cexpr/get_cexpr_meson_corr2"
    #
    def calc_cexpr():
        exprs = [
...
def get_cexpr_meson_corr3():
    fn_base = "cache/auto_contract_cexpr/get_cexpr_meson_corr3"
    #
    def calc_cexpr():
        exprs = [
...
def get_cexpr_meson_quark_mass():
    fn_base = "cache/auto_contract_cexpr/get_cexpr_meson_quark_mass"
    #
    def calc_cexpr():
        exprs = [

...
@q.timer
def get_cexpr_kpipi():
    fn_base = "cache/auto_contract_cexpr/get_cexpr_kpipi"
    #
    def calc_cexpr():
        vol = 1
        exprs_odd_ops = [
        ...
        exprs_pipi = [
            vol**2
            * mk_mom_fac_jj0(0, "x1_1", "x1_2")
            * mk_pipi_i0("x1_1", "x1_2", True)
            + "pipi_I0",
            vol**2
            * mk_mom_fac_jj0(0, "x1_1", "x1_2")
            * mk_pipi_i20("x1_1", "x1_2", True)
            + "pipi_I2",
            vol**2
            * mk_mom_fac_jj0(1, "x1_1", "x1_2")
            * mk_pipi_i0("x1_1", "x1_2", True)
            + "pipi_I0_mom1",
            vol**2
            * mk_mom_fac_jj0(1, "x1_1", "x1_2")
        ...
        diagram_type_dict[
            ((("x", "x"), 1), (("x", "x1_1"), 1), (("x1_1", "x2"), 1), (("x2", "x"), 1))
        ] = "Type3"
        diagram_type_dict[
            ((("x", "x"), 1), (("x", "x2"), 1), (("x1_1", "x1_1"), 1), (("x2", "x"), 1))
        ] = "Type4"
        diagram_type_dict[
            ((("x", "x1_1"), 1), (("x", "x2"), 1), (("x1_1", "x"), 1), (("x2", "x"), 1))
        ] = "Type2"
        diagram_type_dict[
            ((("x", "x1_1"), 1), (("x1_1", "x2"), 1), (("x2", "x"), 1))
        ] = "Type3"
        diagram_type_dict[
            ((("x", "x2"), 1), (("x1_1", "x1_1"), 1), (("x2", "x"), 1))
        ] = "Type4"
        diagram_type_dict[
            ((("x", "x"), 1), (("x", "x1_2"), 1), (("x1_2", "x2"), 1), (("x2", "x"), 1))
        ] = "Type3"
        diagram_type_dict[
            ((("x", "x"), 1), (("x", "x2"), 1), (("x1_2", "x1_2"), 1), (("x2", "x"), 1))
        ] = "Type4"
        diagram_type_dict[
            ((("x", "x1_2"), 1), (("x", "x2"), 1), (("x1_2", "x"), 1), (("x2", "x"), 1))
        ] = "Type2"
        diagram_type_dict[
            ((("x", "x1_2"), 1), (("x1_2", "x2"), 1), (("x2", "x"), 1))
        ] = "Type3"
        diagram_type_dict[
            ((("x", "x2"), 1), (("x1_2", "x1_2"), 1), (("x2", "x"), 1))
        ] = "Type4"
        diagram_type_dict[((("x", "x"), 1), (("x", "x2"), 1), (("x2", "x"), 1))] = (
            "Type4"
        )

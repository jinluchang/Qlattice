...
exprs = [
    ...
    (
        qac.mk_pi_p(p2, is_dagger=True)
        * qac.mk_pi_p(p1)
        * qac.mk_vec_mu(f1, f1, p3, 3),
        None,
        "Type4",
        [
            "Type2",
...
q.json_results_append("get_prop c_pi", q.get_data_sig(c_pi, q.RngState()))

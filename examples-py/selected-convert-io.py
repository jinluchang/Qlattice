...
q.json_results_append("q.get_data_sig(f1, rs)", q.get_data_sig(f1, rs), check_eps)
q.json_results_append("q.get_data_sig(f2, rs)", q.get_data_sig(f2, rs), check_eps)
q.json_results_append("q.get_data_sig(f3, rs)", q.get_data_sig(f3, rs), check_eps)
q.json_results_append("q.get_data_sig(f4, rs)", q.get_data_sig(f4, rs), check_eps)
...
q.json_results_append("q.get_data_sig(sf1, rs)", q.get_data_sig(sf1, rs), check_eps)
q.json_results_append("q.get_data_sig(sf2, rs)", q.get_data_sig(sf2, rs), check_eps)
q.json_results_append("q.get_data_sig(sf3, rs)", q.get_data_sig(sf3, rs), check_eps)
q.json_results_append("q.get_data_sig(sf4, rs)", q.get_data_sig(sf4, rs), check_eps)
...
q.json_results_append("q.get_data_sig(sp1, rs)", q.get_data_sig(sp1, rs), check_eps)
q.json_results_append("q.get_data_sig(sp2, rs)", q.get_data_sig(sp2, rs), check_eps)
...
q.json_results_append(
    "q.glb_sum(q.get_data_sig(f1[:], rs))",
    q.glb_sum(q.get_data_sig(f1[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(f2[:], rs))",
    q.glb_sum(q.get_data_sig(f2[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(f3[:], rs))",
    q.glb_sum(q.get_data_sig(f3[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(f4[:], rs))",
    q.glb_sum(q.get_data_sig(f4[:], rsi)),
    check_eps,
)
...
q.json_results_append(
    "q.glb_sum(q.get_data_sig(sf1[:], rs))",
    q.glb_sum(q.get_data_sig(sf1[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(sf2[:], rs))",
    q.glb_sum(q.get_data_sig(sf2[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(sf3[:], rs))",
    q.glb_sum(q.get_data_sig(sf3[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(sf4[:], rs))",
    q.glb_sum(q.get_data_sig(sf4[:], rsi)),
    check_eps,
)
...
q.json_results_append(
    "q.glb_sum(q.get_data_sig(sp1[:], rs))",
    q.glb_sum(q.get_data_sig(sp1[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(sp2[:], rs))",
    q.glb_sum(q.get_data_sig(sp2[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(sp3[:], rs))",
    q.glb_sum(q.get_data_sig(sp3[:], rsi)),
    check_eps,
)
q.json_results_append(
    "q.glb_sum(q.get_data_sig(sp4[:], rs))",
    q.glb_sum(q.get_data_sig(sp4[:], rsi)),
    check_eps,
)

...
q.json_results_append("mat_tr_sm", np.array([v1, v2]))
...
q.json_results_append("mat_tr_cm", np.array([v1, v2]))
...
q.json_results_append("mat_tr_wm", np.array([v1, v2]))
...
q.json_results_append("mat_tr_wm_wm", np.array([v1, v2, v3, v4]))
...
q.json_results_append("mat_tr_sm_sm", np.array([v1, v2, v3, v4]))
...
q.json_results_append("mat_mul_wm_wm", np.array([v1, v2, v3, v4]))
...
q.json_results_append("mat_mul_sm_sm", np.array([v1, v2, v3, v4]))
...
q.json_results_append("mat_mul_cm_cm", np.array([v1, v2, v3, v4]))
...
q.json_results_append("mat_mul_wm_sm", v1)
...
q.json_results_append("mat_mul_sm_wm", v1)
...
q.json_results_append("mat_mul_wm_cm", v1)
...
q.json_results_append("mat_mul_cm_wm", v1)

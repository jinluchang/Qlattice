...
q.json_results_append(f"test-qar: qar_multi_vol_max_size={int(qar_multi_vol_max_size)}")

q.set_qar_multi_vol_max_size(16 * 1024)
qar_multi_vol_max_size = q.get_qar_multi_vol_max_size()
q.json_results_append(
    f"test-qar: qar_multi_vol_max_size set={int(qar_multi_vol_max_size)}"
)
...
q.json_results_append(f"test-qar: num_clean_up_qfiles={int(num_clean_up_qfiles)}")

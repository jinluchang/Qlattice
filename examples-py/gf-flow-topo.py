...
q.json_results_append("gf plaq", plaq, 1e-10)
q.json_results_append("gf plaq_min", plaq_min, 1e-10)
q.json_results_append("gf_sig", gf_sig, 1e-10)
...
q.json_results_append("flow_time", flow_time, 1e-10)
...
q.json_results_append(
    f"gf_flow_topo ; Freeze ; num_step={num_step} ; step_size={step_size:.3f}"
)
q.json_results_append("flow_time", flow_time, 1e-10)
...
q.json_results_append(
    f"gf_flow_topo ; Shrink ; num_step={num_step} ; step_size={step_size:.3f}"
)
q.json_results_append("flow_time", flow_time, 1e-10)
...
q.json_results_append(
    f"gf_flow_topo ; Localize ; num_step={num_step} ; step_size={step_size:.3f}"
)
q.json_results_append("flow_time", flow_time, 1e-10)
...
step_size = 0.1
for i in range(num_step):
    flow_time += q.gf_flow_topo(gf, step_size, "Preserve")
q.json_results_append(
    f"gf_flow_topo ; Preserve ; num_step={num_step} ; step_size={step_size:.3f}"
)
q.json_results_append("flow_time", flow_time, 1e-10)

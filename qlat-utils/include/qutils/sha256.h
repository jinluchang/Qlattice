...
inline void processBlock(uint32_t newHash[8], const uint32_t oldHash[8],
...
inline void processInput(uint32_t hash[8], const uint32_t oldHash[8],
...
inline void rawHashFromHash(uint8_t rawHash[HashBytes],

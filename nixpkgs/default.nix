let
  ...
  qlat = pkgs.python3Packages.callPackage ./qlat.nix { inherit qlat_utils is-pypi-src; };
  qlat_grid = pkgs.python3Packages.callPackage ./qlat_grid.nix { inherit qlat grid-lehner is-pypi-src; };
  qlat_cps = pkgs.python3Packages.callPackage ./qlat_cps.nix { inherit qlat cps is-pypi-src; };
  ...
  gpt-lehner = pkgs.python3Packages.callPackage ./gpt-lehner.nix { inherit grid-lehner; };
in qlat-pkgs

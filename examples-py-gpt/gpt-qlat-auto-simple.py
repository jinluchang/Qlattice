...
from qlat_scripts.v1 import (
    ...
    run_get_prop, run_r_list, get_r_list, get_r_sq_interp_idx_coef_list,
    benchmark_eval_cexpr, is_test,
)
from auto_contractor.operators import (
    mk_fac, mk_pi_p, mk_k_p, mk_sw5, mk_j5pi_mu, mk_j5k_mu, mk_jw_a_mu,
    mk_a0_p, mk_kappa_p, mk_j_mu, contract_simplify_compile,
)
...
def auto_contract_meson_corr_psnk_psrc(
    ...
    if not is_fsel_containing_psel:
        q.displayln_info(
            -1,
            "WARNING: fsel is not containing psel. Assuming psel and fsel are independent.",
        )

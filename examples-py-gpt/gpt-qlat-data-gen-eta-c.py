...
set_param("24D", "measurement", "charm_quark_mass_list")([ 0.0850, 0.1, 0.15, 0.2, 0.25, ])
...
set_param("32Dfine", "trajs")(list(range(1000, 2600, 40)))
set_param("32Dfine", "measurement", "charm_quark_mass_list")([ 0.045, 0.1, 0.15, 0.2, 0.25, ])

...
def run_prop_rand_vol_u1_src(
    ...
    *,
    ...
    if not q.obtain_lock(
        f"locks/{job_tag}-{traj}-run_prop_rand_vol_u1_src-{quark_flavor}"
    ):
        return
    gf = get_gf()
    geo = gf.geo
    ...
    rs_rand_u1 = q.RngState(f"seed {get_job_seed(job_tag)} {traj}").split(
        "compute_prop_rand_vol_u1_src(rand_u1)"
    )
    rs_ama = q.RngState(f"seed {get_job_seed(job_tag)} {traj}").split(
        "compute_prop_rand_u1(ama)"
    )
    #
    @q.timer
    def compute_and_save(idx_rand_vol_u1, inv_acc):
        tag = (
            f"idx_rand_vol_u1={idx_rand_vol_u1} ; type={inv_type} ; accuracy={inv_acc}"
        )
        if tag in sfw:
        ...
        fu1 = q.mk_rand_vol_u1(geo, 1, rsi)
...
def compute_prop_psrc_ref(
    job_tag, traj, *, inv_type, inv_type_ref, gf, gt, psel, fsel, f_rand_01, eig
):
    """
    ...
    #
    get_param(job_tag, "prob_acc_1_psrc")
    get_param(job_tag, "prob_acc_2_psrc")
    q.RngState(f"seed {get_job_seed(job_tag)} {traj}").split(
        "compute_prop_psrc_all(ama)"
    )
...
def run_prop_psrc_ref(
    ...
    *,
    ...
    quark_flavor = quark_flavor_list[inv_type]
    if (
        get_load_path(f"{job_tag}/prop-psrc-{quark_flavor}/traj-{traj}/geon-info.txt")
        is not None
    ):
        assert (
            get_load_path(
...
set_param("16IH2", "traj_list")(list(range(1000, 4200, 100)))
set_param("16IH2", "quark_mass_list")(
    [
        0.01,
        0.04,
        0.02963,
...
set_param("16IH2", "quark_flavor_list")(
    [
        "light",
        "strange",
        "charm-1",
...
set_param("16IH2", "cg_params-0-0", "maxiter")(200)
set_param("16IH2", "cg_params-0-0", "maxcycle")(1)
set_param("16IH2", "cg_params-0-1", "maxiter")(200)
set_param("16IH2", "cg_params-0-1", "maxcycle")(2)
set_param("16IH2", "cg_params-0-2", "maxiter")(300)
set_param("16IH2", "cg_params-0-2", "maxcycle")(50)
...
set_param("16IH2", "field_selection_fsel_psrc_prop_norm_threshold")(5e-5)
set_param("16IH2", "measurement", "auto_contractor_chunk_size")(128)

set_param("24D", "traj_list")(
    [
        # 1010, 1040, 1080, 1110, 1120, 1130,
        1030,
        1050,
        1070,
        1090,
...
set_param("24D", "quark_flavor_list")(
    [
        "light",
        "strange",
        "charm-1",
...
set_param("24D", "cg_params-0-0", "maxiter")(200)
set_param("24D", "cg_params-0-0", "maxcycle")(1)
set_param("24D", "cg_params-0-1", "maxiter")(200)
set_param("24D", "cg_params-0-1", "maxcycle")(2)
set_param("24D", "cg_params-0-2", "maxiter")(300)
set_param("24D", "cg_params-0-2", "maxcycle")(50)
...
set_param("24D", "field_selection_fsel_psrc_prop_norm_threshold")(1e-4)
set_param("24D", "measurement", "auto_contractor_chunk_size")(128)

set_param("32Dfine", "traj_list")(
    [
        # 1000, 1010, 1020, 1030, 1040, 1050, 1060, 1070, 1080, 1090, 1120, 1160, 1200,
        1100,
        1110,
        1130,
        1140,
...
set_param("32Dfine", "quark_mass_list")(
    [
        0.0001,
        0.045,
        0.04635,
...
set_param("32Dfine", "quark_flavor_list")(
    [
        "light",
        "strange",
        "charm-1",
...
set_param("32Dfine", "cg_params-0-0", "maxiter")(200)
set_param("32Dfine", "cg_params-0-0", "maxcycle")(1)
set_param("32Dfine", "cg_params-0-1", "maxiter")(200)
set_param("32Dfine", "cg_params-0-1", "maxcycle")(2)
set_param("32Dfine", "cg_params-0-2", "maxiter")(300)
set_param("32Dfine", "cg_params-0-2", "maxcycle")(50)
...
set_param("32Dfine", "field_selection_fsel_psrc_prop_norm_threshold")(1e-4)
